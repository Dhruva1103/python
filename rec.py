...
root.config(bg='#FF5F6D')

button_frame = tk.Frame(root, bg='#FF5F6D')
button_frame.pack(pady=10)

# Set the background color of the buttons
add_button = tk.Button(button_frame, text="Add Recipe", command=add_recipe, bg='red', fg='white')
add_button.grid(row=0, column=3, padx=10)

search_button = tk.Button(button_frame, text="Search", command=search_action, bg='brown', fg='white')
search_button.grid(row=0, column=1, padx=10)

filter_button = tk.Button(button_frame, text="Filter by Ingredient", command=filter_action, bg='orange', fg='black')
filter_button.grid(row=0, column=2, padx=10)

search_label = tk.Label(root, text="Search by Name or Ingredients:", bg='maroon',fg='white')
search_label.pack(padx=10,pady=5)

search_entry = tk.Entry(root, width=50,bg='black',fg='white')
search_entry.pack(padx=10,pady=5)

filter_label = tk.Label(root, text="Filter by Ingredient:", bg='maroon',fg='white')
filter_label.pack(padx=10,pady=5)

filter_entry = tk.Entry(root, width=50,bg='black',fg='white')
filter_entry.pack(padx=10,pady=5)

# Set the background color of the result text widget
result_text = tk.Text(root, height=12, width=70, bg='skyblue')
result_text.pack(padx=100,pady=30)
